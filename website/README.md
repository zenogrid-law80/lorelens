...
제품 소개, 기능, 앱 스크린샷, 작업 흐름, Windows 빌드 안내를 제공합니다. 가운데 이미지는 제공된 `dist/img.png`를 원본 `img.png`로 보관하여 사용합니다. 빌드할 때 `dist/img.png`로 복사됩니다. 다운로드 파일이나 미지원 OS를 제공하는 것으로 표시하지 않습니다.
